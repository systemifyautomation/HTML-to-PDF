...
> **Updated**: Now with one-line SSH key-based updates! See [QUICK_UPDATE_GUIDE.md](QUICK_UPDATE_GUIDE.md) for the latest method.

## 🚀 Recommended Method: One-Line Update
...
ssh root@your-vps.com "mkdir -p ~/.ssh && chmod 700 ~/.ssh && echo '$pubkey' >> ~/.ssh/authorized_keys && chmod 600 ~/.ssh/authorized_keys"
```
...
- ✅ Restarts service
- ✅ Verifies deployment
- ✅ Shows version and changes

**See [QUICK_UPDATE_GUIDE.md](QUICK_UPDATE_GUIDE.md) for complete instructions.**

---

## Alternative: Git-Based Update

### Method 1: One-Command Update (Docker)
